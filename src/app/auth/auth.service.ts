...
export class AuthService {
  ...
  signUp(email: string, password: string) {
    return this.http
      .post<AuthResponseData>(
        ...
        'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDDYK0bslSJ-GlFmDwkSt4and19y_yUOQk',
        {
          email: email,
          password: password,
  ...
  login(email: string, password: string) {
    return this.http
      .post<AuthResponseData>(
        'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDDYK0bslSJ-GlFmDwkSt4and19y_yUOQk',
        {
          email: email,
          password: password,
          returnSecureToken: true,
